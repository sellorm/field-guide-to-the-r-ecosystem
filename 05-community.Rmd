...
* [R Weekly](https://rweekly.org/) is a community curated news site for R users with a weekly newsletter. Anyone can share content (blog posts, new packages, gists, conference calls for papers, etc.) that they created or saw via [this form](https://rweekly.org/submit) or via opening a [(https://github.com/rweekly/rweekly.org/), so that it gets included in the next issue.
